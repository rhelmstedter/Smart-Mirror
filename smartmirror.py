...
ZIP = "93003"
weather_url = (
    f"https://api.openweathermap.org/data/2.5/weather?zip={ZIP},us&appid={API_KEY}"
)
...
class Clock(Frame):
    def __init__(self, parent):
        ...
        self.time1 = ""
        self.timeLbl = Label(
            self, font=("Helvetica", LARGE_TEXT_SIZE), fg="white", bg="black"
        )
...
class Weather(Frame):
    def __init__(self, parent, *args, **kwargs):
        ...
        self.temperatureLbl = Label(
            self.degreeFrm, font=("Helvetica", XLARGE_TEXT_SIZE), fg="white", bg="black"
        )
    ...
    def get_headlines(self):
        try:
            ...
            if news_country_code == None:
                ...
                headlines_url = (
                    "https://news.google.com/news?ned=%s&output=rss" % news_country_code
                )
